//
//  CompleteTasksTableViewTableViewController.m
//  Agendue
//
...
@interface CompleteTasksTableViewTableViewController () {
    Project *_project;
...
@implementation CompleteTasksTableViewTableViewController
...
- (void)configureTable {
    ...
    [iOSRequest getCompleteTasksForUserForProject:_project.webID onCompletion:^(NSData *results, NSError *err) {
...
- (NSArray *) leftButtons
{
    ...
    [leftUtilityButtons addObject:[MGSwipeButton buttonWithTitle:@"" icon:[UIImage imageNamed:@"markcomplete.png"] backgroundColor:[UIColor redColor]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!([[((Task *)_objects[indexPath.row]).webID class] isSubclassOfClass:[NSString class]])) {
        [self performSegueWithIdentifier:@"completeTasksToDetails" sender:self];
    }
...
{
    if ([[segue identifier] isEqualToString:@"completeTasksToDetails"]) {
